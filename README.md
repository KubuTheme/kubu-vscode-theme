...
Aside from syntax highlighting for all the languages supported in vscode by default (like **Python**, **Javascript**, etc.), Kubu also implements special coloring rules for tokens generated by some other third-party syntax highlighting extensions:
